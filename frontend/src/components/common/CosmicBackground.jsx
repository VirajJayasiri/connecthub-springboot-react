...
const CosmicBackground = () => {
  ...
  const auroras = useMemo(() => {
    return [
      { id: 1, color: 'bg-emerald-500', top: '-10%', left: '10%', delay: '0s', duration: '15s' },
      { id: 2, color: 'bg-blue-500', top: '-15%', left: '40%', delay: '5s', duration: '18s' },
      { id: 3, color: 'bg-purple-500', top: '-10%', left: '70%', delay: '10s', duration: '20s' },
      { id: 4, color: 'bg-teal-400', top: '-20%', left: '25%', delay: '2s', duration: '22s' },
    ];
  }, []);
      ...
      {stars.map((star) => (
        <div
          ...
          style={{
            ...
            boxShadow: star.size === '3px' ? '0 0 6px 1px rgba(255, 255, 255, 0.6)' : 'none',
          }}
        />
      ))}
    </div>

...
const FriendsPage = () => (
  <div className="app-page">
    ...
    <div className="max-w-2xl mx-auto px-4 py-12 text-center text-gray-400 dark:text-gray-500">
      <Users size={48} className="mx-auto mb-4 text-gray-300 dark:text-gray-700" strokeWidth={1.5} />
      <h2 className="text-xl font-semibold text-gray-700 dark:text-gray-200 mb-1">Friends</h2>

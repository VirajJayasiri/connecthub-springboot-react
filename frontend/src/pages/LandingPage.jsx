          ...
          <div className="flex-1 flex overflow-hidden">
            ...
            <div className="w-72 border-r border-white/10 flex flex-col bg-[#050505] hidden md:flex">
              <div className="p-4 border-b border-white/10">
                <h3 className="text-sm font-semibold mb-3 text-white">Chat Rooms</h3>
              ...
              <div className="flex-1 overflow-y-auto flex flex-col gap-1 p-2 custom-scrollbar">
                ...
                <div className="p-3 rounded-lg hover:bg-white/5 cursor-pointer border border-transparent transition-colors">
                  <div className="flex justify-between items-start mb-1">
                    <span className="text-sm font-semibold flex items-center gap-2 text-neutral-200"><MessageSquare size={14} className="text-neutral-400"/> Web Development</span>
            ...
            <div className="flex-1 bg-[#0a0a0a] flex flex-col relative overflow-hidden">
               ...
               <div className="p-6 border-b border-white/10 bg-[#0a0a0a] flex-shrink-0">
                 <h2 className="text-xl font-semibold flex items-center gap-2 mb-2 text-white"><Mic size={20} className="text-white"/> Gaming Voice Chat <span className="text-[10px] border border-white/10 px-2 py-0.5 rounded text-neutral-400 ml-2 font-normal align-middle">Voice Chat</span></h2>
               ...
               <div className="absolute bottom-10 w-full flex flex-col items-center gap-4">
                 <div className="flex gap-6">
                   ...
                   <button className="w-14 h-14 rounded-full bg-red-600 text-white flex items-center justify-center hover:scale-110 transition-transform">
                     <PhoneOff size={24} />
                   </button>
                 </div>
               </div>
...
const Features = () => {
  ...
  return (
    <section id="features" className="py-24 relative bg-neutral-950 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="p-8 rounded-2xl glass transition-colors group cursor-pointer border border-white/5 hover:border-white/20 relative overflow-hidden"
            >
              <div className="w-12 h-12 rounded-xl bg-neutral-900 flex items-center justify-center mb-6 text-white">
                {feature.icon}
              </div>
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
            <button 
              onClick={() => navigate('/register')}
              className="px-8 py-4 rounded-full bg-white text-black font-semibold hover:scale-105 transition-transform flex items-center justify-center gap-2"
            >
              Create an Account <ChevronRight size={18} />
            </button>
            <button className="px-8 py-4 rounded-full bg-neutral-800 text-white font-semibold hover:bg-neutral-700 transition-colors border border-white/5">
              Explore Rooms
            </button>
          </div>
        </motion.div>
...
const Footer = () => {
  return (
    <footer className="border-t border-white/10 pt-16 pb-8 bg-black text-white">
      <div className="max-w-7xl mx-auto px-6">
